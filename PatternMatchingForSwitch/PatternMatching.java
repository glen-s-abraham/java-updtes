...
public class PatternMatching {
    ...
    public static void infoOnType(Object o) {
        switch (o) {
            // Guarded patterns (Java 17, preview) are now replaced by the 'when' clause
            // (Java 19, preview).
            // case String s && s.startsWith("A")-> System.out.println("String beginning
            // with A : "+s);
            // case Integer i && i.intValue() > 10 -> System.out.println("Integer > 10 :
            // "+i);
